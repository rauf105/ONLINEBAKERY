...
if(isset($_POST['add_product'])) {
    ...
    $target = "uploads/" . time() . "_" . basename($img); 
        ...
        <div class="card">
            ...
            <form method="POST" enctype="multipart/form-data" style="margin-top: 20px;">
                <div style="display: flex; gap: 15px; margin-bottom: 15px;">
                    <input type="text" name="p_name" placeholder="Item Name" required style="flex: 2;">
                ...
                <div style="display: flex; gap: 15px;">
                    <input type="number" step="0.01" name="price" placeholder="Price (৳)" required style="flex: 1;">
                    <input type="number" name="stock" placeholder="Initial Stock" required style="flex: 1;">
                    <input type="file" name="p_image" required style="flex: 1; padding-top: 8px;">
                </div>
